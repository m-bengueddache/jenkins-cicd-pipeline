...
> **FR** — Pipeline CI/CD Jenkins pour une application Java Maven : incrémentation de version sémantique automatique, build, build d'image Docker, push vers Docker Hub, et commit automatique de la version dans Git.
>
> **EN** — Jenkins CI/CD pipeline for a Java Maven application: automatic semantic version increment, build, Docker image build, Docker Hub push, and automatic version commit to Git.
